...
public class PatientUserListActivity extends AppCompatActivity {

    private FirebaseDatabase database;
    private DatabaseReference firebasePatientsReference, firebaseUsersReference;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        firebasePatientsReference = database.getReference(App.FIREBASE_DB_PATH_PATIENT_USERS);
        ...
        adapter = new RvAdapter(usersList, new RvAdapter.OnItemClickListener() {
            ...
            public void onItemDeleteClicked(final User item, int adapterPosition) {
                new AlertDialog.Builder(PatientUserListActivity.this)
                        .setTitle("Confirm Delete")
                        .setMessage("Are you sure you want to delete this patient account?")
        ...
        firebasePatientsReference.addChildEventListener(childEventListener);
    }

    private void deleteUser(String username) {
        firebasePatientsReference.child(username).removeValue();
        firebaseUsersReference.child(username).removeValue();
    }

    @Override
    protected void onStop() {
        if (firebasePatientsReference != null && childEventListener != null)
            firebasePatientsReference.removeEventListener(childEventListener);
        super.onStop();
    }
